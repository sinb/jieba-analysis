...
/**
 * 和jibasegmenter功能一样，但是它的词典文件需要通过构造函数传入
 * */
public class JiebaSegmenters {
    private WordDictionaries wordDict = null;
    ...
    public JiebaSegmenters(WordDictionaries myWordDictionary)
    {
        wordDict = myWordDictionary;
    }
